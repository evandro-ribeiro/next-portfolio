...
export default function InitialBanner() {
    ...
    return (
        <section>
            ...
            <div className="flex justify-center md:pt-10 md:pb-6 backdrop-blur-sm">
                <motion.div 
                    className="flex md:flex-col text-center gap-2 md:gap-14 py-7 md:py-0 md:pt-16 justify-center items-center"
                ...
                >
                    <div className="w-1/2">
                        <motion.h1 
                            className="md:text-5xl text-[#F0EDCF] pb-3 md:pb-10"
                            initial="hidden"
                            animate="visible"
                        ...
                        <p className="text-zinc-50 text-xs md:text-base">Deixe sua marca na web e crie seu próprio site personalizado para mostrar seu produto ou serviço.</p>
                    </div>
                    <Link
            ...
            <div className="md:mt-14 flex flex-col md:gap-8 md:mb-16">
                ...
                <div className="flex flex-wrap md:gap-28 gap-4 py-2 justify-center">
                    <span className="text-sm md:text-base backdrop-blur-lg flex font-semibold gap-2 items-center p-1 md:p-4 rounded-full shadow-md shadow-sky-700 md:shadow-white md:text-gray-100 text-sky-700 duration-200 hover:text-sky-700 hover:shadow-sky-300 hover:scale-110"><FaReact className={logoStyle} />ReactJS</span>
                    <span className="text-sm md:text-base backdrop-blur-lg flex font-semibold gap-2 items-center p-1 md:p-4 rounded-full shadow-md shadow-amber-300  md:shadow-white md:text-gray-100 text-amber-300 duration-200 hover:text-amber-300 hover:shadow-amber-300 hover:scale-110"><SiJavascript className={logoStyle} />JavaScript</span>
                    ...
                    <span className="text-sm md:text-base backdrop-blur-lg flex font-semibold gap-2 items-center p-1 md:p-4 rounded-full shadow-md shadow-blue-600  md:shadow-white md:text-gray-100 text-blue-600 duration-200 hover:text-blue-600 hover:shadow-blue-300 hover:scale-110"><FaCss3Alt className={logoStyle} />CSS</span>
