...
export default function Contact() {
    ...
    return (
        <div className="flex flex-col md:flex-row md:gap-6 justify-between py-24 md:px-72 items-center bg-dark-gradient h-96" id="contact">
            <div className="text-center flex flex-col gap-6 md:gap-14">
                <h2 className="text-white text-2xl md:text-3xl font-bold">
                    Deseja criar o  
                    <motion.span transition={{ staggerChildren: 0.1, ease: "easeInOut" }} initial="initialColor" animate="transitionColor">
            ...
            <Link href={"https://wa.me/5544999561963"} target="blank">
                <motion.button
